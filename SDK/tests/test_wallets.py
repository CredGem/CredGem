...
async def test_wallet_with_balance(client, credit_type):
    ...
    balance = next(b for b in updated_wallet.balances if b.credit_type_id == credit_type.id)
...
async def test_wallet_with_multiple_credit_types(client):
    ...
    balance1 = next(b for b in updated_wallet.balances if b.credit_type_id == credit_type1.id)
    balance2 = next(b for b in updated_wallet.balances if b.credit_type_id == credit_type2.id)
